...
<BODY  background="img/b6.png" link="white" alink="white" vlink="white">
<FONT size="5"><!--NAV align="right">
...
<TR class="left">
<TD><FONT size="5" color="BLACK">First name:</FONT></TD>
    <TD><INPUT name="fname" type="TEXT" placeholder="Enter your first name" size="30" maxlength="30" align="center" id="fname"></INPUT></TD>
</TR>
<TR class="left">
<TD><FONT size="5" color="WHITE">Last name:</FONT></TD>
    <TD><INPUT type="TEXT" name="lname" align="center" size="30" maxlength="30" placeholder="Enter your last name" id="lname"></INPUT></TD>
</TR>
<TR class="left">
...
<OPTION VALUE="Baner" style="color:black;">Baner</OPTION>
<OPTION VALUE="Bibvewadi" style="color:black;">Bibvewadi</OPTION>
</SELECT></TD>
</TR>
<TR class="left">
...
<INPUT type="checkbox" name="tc" value="tc">
    I have read and accepted the Terms and Conditions and <BR>&nbsp&nbsp&nbsp&nbsp&nbsp Privacy Policy</BR></INPUT></FONT></TD>
</TR>
</TABLE>
<P><INPUT TYPE="Submit" value="Submit" name="submit" id="submit" class="button" onclick="if(!this.form.tc.checked){alert('You must agree to the terms first.');return false}">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <INPUT TYPE="Reset" value="Reset" id="reset" class="button"/></INPUT></P></FORM>
<HR width="1000">
<FORM action="login.php">
<P align="CENTER"><FONT size="6" color="white" face="Arial">
    Already have an account with us?</FONT>
